...
from app.core.feature_permissions import MY_FAVORITES
...
def _require_my_favorites(
    user: AuthenticatedUser = Depends(get_current_user),
) -> AuthenticatedUser:
    ensure_feature(user, MY_FAVORITES)
    return user
...
async def get_favorites(
    ...
    current_user: AuthenticatedUser = Depends(_require_my_favorites),
