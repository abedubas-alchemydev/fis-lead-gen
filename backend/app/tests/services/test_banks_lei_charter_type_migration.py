...
def test_chain_has_a_single_head() -> None:
    ...
    # currently the favorites bank-target migration (20260708_0001), an
    # additive child of the banks People-parity email-extractor bank_id
    # migration (20260703_0004).
    assert _script_directory().get_heads() == ["20260708_0001"]
