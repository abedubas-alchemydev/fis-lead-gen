...
type LegacyMasterListClientProps = {
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
        <aside className="rounded-[28px] border border-white/80 bg-white/92 p-5 shadow-shell">
        ...
        <div className="space-y-5">
          <div className="rounded-[28px] border border-white/80 bg-white/92 p-5 shadow-shell">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
              ...
              >
                ...
                <button
                  type="submit"
                  className="h-[50px] rounded-2xl bg-navy px-5 text-sm font-medium text-white transition hover:bg-[#112b54] lg:self-end"
                >
                  Search
                </button>
              </form>
          ...
          <div className="overflow-hidden rounded-[28px] border border-white/80 bg-white/92 shadow-shell">
                    ...
                    items.map((item) => (
                      ...
                      >
                        <td className="px-5 py-4 text-sm font-medium text-navy">
                          <Link href={`/master-list/${item.id}`} className="hover:text-blue">
                            {item.name}
                          </Link>
                          {item.is_deficient ? (
                        ...
                        <td className="px-5 py-4 font-mono text-sm text-slate-700">{item.cik}</td>
                        <td className="px-5 py-4 text-sm text-slate-700">
                          <div className="space-y-2">
                            <p>{item.current_clearing_partner ?? "Unknown"}</p>
                        ...
                        <td className="px-5 py-4 text-sm text-slate-700">{item.last_filing_date ?? "-"}</td>
                      </tr>
                    ))
                  )}
                </tbody>
